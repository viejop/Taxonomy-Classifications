class Kingdom:
    def __init__(self, kingdom):  #establishes kingdom class
        super().__init__()
        self.kingdom = kingdom
        self.kingdominfo = self.kingdomDescription()
        
        #defines kingdom class
...
class Phylum(Kingdom):
    def __init__(self, phylum, kingdom):   #establishes phylum object
        super().__init__(kingdom)
        self.phylum = phylum
        self.phyluminfo = self.phylumDescription()

        #defines phylum object
...
class Class(Phylum):
    def __init__(self, class_, phylum, kingdom):   #establishes class object
...
class Order(Class):
    def __init__(self, order, class_, phylum, kingdom):   #establishes order object
...
class Family(Order):
    def __init__(self, family, order, class_, phylum, kingdom):   #establishes family object
...
class Genus(Family):
    def __init__(self, genus, family, order, class_, phylum, kingdom): #establishes genus object
        super().__init__(family, order, class_, phylum, kingdom)
        self.genus = genus
        self.genusinfo = self.genusDescription()

        #defines genus object
...
class Species(Genus):
    def __init__(self, species, genus, family, order, class_, phylum, kingdom):   #establishes species object
        super().__init__(genus, family, order, class_, phylum, kingdom)
        self.species = species
        self.speciesinfo = self.speciesDescription()

        #defines species object
...
def titleScreen():
    ...
    #loop to run the function over
    while True:
        print("1. Beagle\n2. Labrador Retriever\n3. German Shepherd\n4. Poodle\n5. Dachshund\n6. Chihuahua\n7. Golden Retriever\n8. Boxer\n9. Rottweiler\n10. Siberian Husky\n11. Shih Tzu\n12. Bulldog\n13. How to use\n14. Quit")
        titleInput = input("")   #asks for input

        if titleInput.isdigit():
            titleInput = int(titleInput)
            #logic for inputs taken
            if titleInput == 1:
                beagle()
            elif titleInput == 2:
                labradorRetriever()
                ...
                bulldog()
            elif titleInput == 13:    #helps the user
                print("Here's how to use...\n")
                print("Input any number 1 through 12 to find a taxonomy entry for the dog breed listed. This taxonomy entry will give a detailed description of the dog's kingdom, phylum, class, order, family, genus, and lastly its species. \nThere is also a nice picture of each dog attached.")
            elif titleInput == 14:
                print("Shutting down...")
                break  #breaks the outer loop and exit the program
            else:
        ...
        #asks if they want to return to the home screen
        runAgain = input("Press any key to return to the home screen, or 'q' to quit: ").strip().lower()
        if runAgain == 'q':
            print("Shutting down...")
            break  #exit the program
        elif runAgain:
            continue  #if they press any key other than 'q' the loop continues
